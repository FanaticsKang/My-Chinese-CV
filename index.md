...
- **核心成果**：半稠密建图【业界唯一量产】、OCC建图精度2.78cm【<5cm目标达成，业界领先】、激光里程计千分之3.5【量产最优】
- 牵头完成量产车型的全车下线标定，售后标定和在线标定; **【量产：启源E07, Q07】**
- 结构化道路众包建图与定位负责人，主导从车端传感器数据实时构建类高精地图的技术方案与落地; **【量产：启源E07】**
- 牵头完成**业界唯一量产级传统半稠密建图**（替代OCC）。算法完成目标车位周边的实时半稠密建图，有效解决悬空障碍物检测难题，精准识别雨伞、乒乓球桌等极端Case，提升泊车安全性;**【量产：启源Q07】**
- 牵头大规模高精度OCC数据链路设计：**建图精度2.78cm（达成<5cm设计目标，业界领先）**，对标指标 Tesla 10cm；参与传感器选型、支架设计、多激光大规模Bundle Adjustment（5激光雷达，600帧建图，约3000千万点云，单激光雷达精度2.5cm）；
- 牵头设计**量产最优级别高精度激光雷达里程计**：量产激光精度5cm，里程计达成全程**千分之3.5精度**（每10米仅3.5cm误差），指标对齐华为SuperOdom；**【量产：启源Q07】**
- 牵头设计BEV网络的地面高度估计模块，用于更好与PV进行配合。**【量产：启源Q07】**
- 牵头BEV网络静态，动态的模型后处理工作。**【量产：启源Q07】**

### __智能驾驶定位系统技术负责人__`长安 2022-2023`
- 基于高精度地图的ICP定位算法，支持量产高速辅助驾驶功能; **【量产：深蓝SL03, S7】**;
